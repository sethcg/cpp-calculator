...
const inline wxString BUTTON_STRING_ALL_CLEAR = "\u0041\u0043";    // STRING VALUE: "AC"
...
const inline wxString BUTTON_STRING_MULTIPLY = "\u00D7"; // STRING VALUE: "x"
...
const inline wxString BUTTON_STRING_NEGATE = "\u00B1";   // STRING VALUE: "±"
